...
public:
    ...
    virtual void setSafetyAstateValue(int val);		//protection state a voltage and current
    virtual void setSafetyBstateValue(int val);		//protection state b temperatures
